document.addEventListener("DOMContentLoaded", function () {
  ...
  document.getElementById(
      'reservationNumber').textContent = "${reservation.reservationNo}";
  document.getElementById(
      'department').textContent = "${doctor.departmentName}";
  document.getElementById('doctor').textContent = "${doctor.name}";
  document.getElementById(
      'appointmentDate').textContent = "${reservation.appointmentAt}";
  ...
  // 추가 예약하기 버튼
  document.getElementById('addAnotherReservation').addEventListener('click',
      function () {
        // 추가 예약 페이지로 이동
